...
const guessLimitEle = document.querySelector("#guessLimit");
...
function hint() { // Begin hint
  ...
  if (guess < currentNumber) { // if guess is less than currentNumber
...
function processGuess () { // Begin processGuess
  ...
  if (evaluateGuess()){ // If the guess is correct
